...
class SMS extends Controller
{
  ...
  private function dPrefix()
  {
    ...
    $this->user = $this->db->table('tac_users')->select('username','mavis_sms_number','group')->where([['username', $this->mavis->getUsername()], ['mavis_sms_enabled', 1], ['mavis_otp_enabled', 0]]);
