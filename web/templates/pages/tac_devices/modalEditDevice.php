...
<div id="editDevice" class="modal fade" role="dialog">
	...
	<div class="modal-content">
		...
		<form id="editDeviceForm" form-action="edit">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li class=""><a href="#info_edit" data-toggle="tab" aria-expanded="false">Info</a></li>
				...
				<div class="tab-content">
					...
					<!-- /.tab-pane -->
					<div class="tab-pane" id="info_edit">
		...
		<div class="modal-footer">
			...
			<button type="button" class="btn btn-flat btn-success" onclick="tgui_device.edit()">Edit Device</button>
		</div>
	</div>
	</div>
</div>
