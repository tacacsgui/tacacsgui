...
<div id="editDevice" class="modal fade" role="dialog">
	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title">Edit Device <deviceName class="text-green"></deviceName></h4>
		</div>
				...
				<div class="form-group name">
					...
					<div class="input-group">
						...
						<div class="input-group-btn disabled">
							<button type="button" class="btn btn-flat btn-success" onclick="disabledSwitcher('edit')">Enabled</button>
					...
					<div class="form-group ipaddr">
						...
						<div class="input-group">
							...
							<div class="input-group-btn">
								<button type="button" class="btn btn-gray btn-flat" onclick="ping('edit')">Ping</button>
							</div>
						</div>
					</div>
				</div>
...
Switch#</cli_text_general>
		...
		<div class="modal-footer">
			...
			<button type="button" class="btn btn-flat btn-success" onclick="submitDeviceChanges()">Edit Device</button>
		</div>			
	</div>
	</div>
</div>
