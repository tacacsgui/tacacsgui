...
<div class="row">
  <div class="col-lg-6 col-md-6">
    <div class="form-group vendor">
      ...
      <input type="hidden" name="vendor_native" value="">
  ...
  <div class="col-lg-6 col-md-6">
    <div class="form-group model">
      ...
      <input type="hidden" name="model_native" value="">
      <p class="text-muted">device model, e.g. Catalyst 2960</p>
    </div>
  </div>
</div>
<div class="row">
  ...
  <div class="col-lg-6 col-md-6">
    <div class="form-group sn">
      ...
      <input type="hidden" name="sn_native" value="">
      <p class="text-muted">device serial number</p>
    </div>
  </div>
</div>
