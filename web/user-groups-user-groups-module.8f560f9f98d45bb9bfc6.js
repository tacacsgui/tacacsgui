...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.fillForm = function (id) {
        ...
        this.usrGrp_service.get(id).subscribe(function (data) {
            ...
            console.log(data);
            rxjs_1.forkJoin(_this.pre.get('/mavis/ldap/group/list/', data.ldap_groups.join(',') || 0), _this.pre.get('/tacacs/acl/list/', data.acl.join(',')), _this.pre.get('/tacacs/device/list/', data.device_list.join(',') || 0), _this.pre.get('/tacacs/device/group/list/', data.device_group_list.join(',') || 0)).pipe(operators_1.map(function (_a) {
                var ldap_groups = _a[0], acl = _a[1], device_list = _a[2], device_group_list = _a[3];
                console.log(ldap_groups, acl, device_list, device_group_list);
                var returnData = {};
                if (ldap_groups)
...
//# sourceMappingURL=user-groups-user-groups-module.8f560f9f98d45bb9bfc6.js.map