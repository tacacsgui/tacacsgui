...
var SystemInfoService = /** @class */ (function () {
    ...
    SystemInfoService.prototype.checkUpdate = function () {
...
var WSystemInfoComponent = /** @class */ (function () {
    function WSystemInfoComponent(service, service_) {
        this.service = service;
    ...
    WSystemInfoComponent.prototype.checkUpdate = function () {
        var _this = this;
        this.service.checkUpdate().subscribe(function (data) {
            console.log(data);
            if (data.output.client_version !== data.output.last_version.version)
                _this.service_.update = true;
        });
    };
...
//# sourceMappingURL=app-views-pages-dashboard-dashboard-module.7d7d451fc851ccf2c01e.js.map