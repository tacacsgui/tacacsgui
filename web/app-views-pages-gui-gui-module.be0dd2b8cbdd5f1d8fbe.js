...
module.exports = "<div class=\"row\">\n\t<div class=\"col-md-3 col-sm-6\" *ngFor=\"let card of cards\">\n    <div class=\"card\">\n      <div class=\"card-body\">\n        <h5 class=\"card-title\">{{card.title}}</h5>\n        <!-- <h6 class=\"card-subtitle mb-2 text-muted\">Card subtitle</h6> -->\n        <div class=\"text-center\">\n          <p class=\"card-text\">\n            <a [routerLink]=\"card.list\">\n              <span style=\"font-size: 5em;\" [ngStyle]=\"{'color': card.icon_color}\">\n                <i class=\"{{card.icon}}\"></i>\n              </span>\n            </a>\n          </p>\n        </div>\n        <hr>\n        <div class=\"text-center\">\n          <a [routerLink]=\"card.list\" class=\"btn btn-warning btn-elevate btn-elevate-air\" *ngIf=\"card.list\">\n\t\t\t\t\t\t{{ (card.viewbtn) ? card.viewbtn : 'View'}}\n\t\t\t\t\t</a>&nbsp;\n\t\t\t\t\t<a [routerLink]=\"card.add\" class=\"btn btn-success btn-elevate btn-elevate-air\" *ngIf=\"card.add\">\n\t\t\t\t\t\tAdd New\n\t\t\t\t\t</a>&nbsp;\n        </div>\n      </div>\n    </div>\n    <br>\n  </div>\n</div>\n"
...
//# sourceMappingURL=app-views-pages-gui-gui-module.be0dd2b8cbdd5f1d8fbe.js.map