...
var upgrade_service_1 = __webpack_require__(/*! ../upgrade/upgrade.service */ "./src/app/views/pages/upgrade/upgrade.service.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(layoutConfigService, router, upg, super_) {
        this.layoutConfigService = layoutConfigService;
        this.router = router;
        this.upg = upg;
        this.super_ = super_;
        this.destroy$ = new rxjs_1.Subject();
        upg._search().subscribe(function (data) {
...
//# sourceMappingURL=app-views-pages-dashboard-dashboard-module.3f92ad1587bc5586178d.js.map